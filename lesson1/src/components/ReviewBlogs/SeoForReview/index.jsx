          ...
          <div className="row">
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="DesignBlogsCards">
                ...
                <div className="DesignBlogsCardsImg">
                  <img
                    src="https://new.axilthemes.com/demo/react/blogar/images/posts/thumbnail-08.webp?imwidth=640"
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="DesignBlogsCards">
                ...
                <div className="DesignBlogsCardsImg">
                  <img
                    src="https://new.axilthemes.com/demo/react/blogar/images/posts/post-seo-list-03.webp?imwidth=640"
...
export default SeoBlogsForReview;
