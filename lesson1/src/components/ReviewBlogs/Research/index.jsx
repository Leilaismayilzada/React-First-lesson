...
const ResearchBlogsForReview = () => {
  const [Research, setResearch] = useState([]);

  useEffect(() => {
    getImages("/Research", (data) => {
      if (data) {
        setResearch(data); 
      } else {
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="DesignBlogsCards">
                ...
                <div className="DesignBlogsCardsImg">
                  <img
                    src="https://new.axilthemes.com/demo/react/blogar/images/posts/post-seo-sm-01.webp?imwidth=640"
...
export default ResearchBlogsForReview;
