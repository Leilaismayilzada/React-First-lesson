...
const BrandingBlogsForReview = () => {
  const [Branding, setBranding] = useState([]);

  useEffect(() => {
    getImages("/Branding", (data) => {
      if (data) {
        setBranding(data);
      } else {
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="DesignBlogsCards">
                <div className="DesignBlogsCardsHead">
                  <h3>Branding</h3>
                  <p>
                    Overcoming Blockers How to Build Your Red
                    <br /> Tape Toolkit
                  </p>
                </div>
                <div className="DesignBlogsCardsImg">
                  <img
                    src="https://new.axilthemes.com/demo/react/blogar/images/posts/post-seo-list-05.webp?imwidth=640"
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="DesignBlogsCards">
                ...
                <div className="DesignBlogsCardsImg">
                  <img
                    src="https://new.axilthemes.com/demo/react/blogar/images/posts/post-column-02.webp?imwidth=640"
...
export default BrandingBlogsForReview;
